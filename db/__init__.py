...
class t_symbols_analyze(_DECL_BASE):
    ...
    f_spread = Column(Float, nullable=False)
    f_bar_trend = Column(Integer, nullable=False)
    f_volume_mean = Column(Float, nullable=False)
    f_volume = Column(Float, nullable=False)
    f_ma_period = Column(Integer, nullable=False)
    f_ma_up = Column(Float, nullable=False)
    ...
    f_breakout_volume = Column(Float, nullable=False)
    f_breakout_volume_rate = Column(Float, nullable=False)
    f_breakout_price_highest = Column(Float, nullable=False)
    f_breakout_price_highest_ts = Column(Integer, nullable=False)
    f_breakout_rate = Column(Float, nullable=False)
    f_breakout_rate_max = Column(Float, nullable=False)
    f_recommend = Column(Float, nullable=False)
    f_ts_update = Column(TIMESTAMP, nullable=False, default=datetime.utcnow)
